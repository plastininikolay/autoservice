        ...
        <div>
            ...
            <main>
                ...
                <section className="why-choose-us" id="why-choose-us">
                    ...
                    <h5>Наш онлайн копицентр — это место, где качество и профессионализм стоят на первом месте. Мы
                        предлагаем широкий спектр услуг, которые помогут вам справиться с любыми задачами, связанными с
                        печатью, копированием и ламинированием документов. А также мы гарантируем оперативную доставку
                        ваших заказов в кратчайшие сроки.</h5>
                    ...
                    <ol className="service-list">
                        <li>
                            <div className="service-details">
                                ...
                                <p>Печать черно-белых и цветных документов в различных форматах, включая A4, A3, А5, А1
                                    и
